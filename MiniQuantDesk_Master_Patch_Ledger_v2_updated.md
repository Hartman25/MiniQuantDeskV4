...
P9-P7A-P7B-REAL-STRESS-01 policy fix (265fd63f, PARTIAL -- P7A/P7B replay
      itself HARD STOPPED, missing durable input, see §24)
        |
        v
RESEARCH_BACKTEST_V1_COMPLETE  — NOT MET / PARTIAL (2026-08-22,
      RESEARCH-BACKTEST-V1-FINAL-AUTHORITY-REPAIR-01; see §24 closing
      summary -- two named, non-fabricated gaps remain open)
        |
        v
