...
| `ETF-RISK-01` Correlation exposure controls | PARTIAL (dead code) | 10% | S | none | `SectorConstraint`/`check_sector_limits()` already written, zero callers | 2 | Second-cheapest win — wire existing code into the live risk engine. |
