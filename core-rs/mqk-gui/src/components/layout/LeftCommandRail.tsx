...
export function LeftCommandRail({
  ...
  const secondary: ScreenKey[] = ["metrics", "transport", "topology", "alerts", "incidents", "operatorTimeline", "session", "config", "marketData", "strategy", "audit", "artifacts", "settings"];
  ...
  return (
    <aside className="left-rail">
      <div className="brand-block panel panel-compact">
        ...
        <p className="brand-subtitle">Institution-style visibility and control surface.</p>
      </div>
