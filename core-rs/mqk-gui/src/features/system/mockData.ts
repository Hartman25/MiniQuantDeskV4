...
export const MOCK_MODEL: SystemModel = {
  ...
  admissionCheck: {
    ...
    reason_unchecked: "mock fallback model — no daemon connection",
    symbol: null,
    strategy_id: null,
    allowed: null,
    reason_code: null,
  ...
  durablePortfolioSummary: {
    ...
    snapshot_truth_state: "unavailable",
    snapshot_id: null,
    ...
    realized_pnl_unavailable_reason: "mock model — no backend truth",
    fees: null,
    cumulative_cash_movement: null,
    unrealized_pnl: null,
    unrealized_pnl_truth_state: "unavailable",
    unrealized_pnl_unavailable_reason: "mock model — no backend truth",
    daily_pnl: null,
    daily_pnl_truth_state: "unavailable",
    daily_pnl_unavailable_reason: "mock model — no backend truth",
    blockers: ["mock model — no backend truth"],
  },
