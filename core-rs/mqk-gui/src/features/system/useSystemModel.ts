...
const FALLBACK_MODEL: SystemModel = {
  ...
  durablePortfolioSummary: {
    ...
    realized_pnl_unavailable_reason: "no daemon connection established yet",
    fees: null,
    cumulative_cash_movement: null,
    unrealized_pnl: null,
    unrealized_pnl_truth_state: "unavailable",
    unrealized_pnl_unavailable_reason: "no daemon connection established yet",
    daily_pnl: null,
    daily_pnl_truth_state: "unavailable",
    daily_pnl_unavailable_reason: "no daemon connection established yet",
    blockers: ["no daemon connection established yet"],
  },
