-- D1-4: Drop DB-time defaults from sys_reconcile_checkpoint.created_at_utc.
--
...
-- checkpoint passed to arm_preflight. Supplying this timestamp via a database
-- time default is non-deterministic and non-injectable. After this migration,
...
-- The following columns retain DB-time defaults as acceptable ops metadata.
...
--   sys_arm_state.updated_at_utc      (0006, also app-managed)
