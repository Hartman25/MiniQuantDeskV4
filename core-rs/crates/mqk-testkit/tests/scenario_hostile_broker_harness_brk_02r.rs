                ...
                if s.fetch_calls == 1 {
                    vec![
                        BrokerEvent::Fill {
                            ...
                            broker_fill_id: Some("02r-econ-fill-1".to_string()),
                ...
                if s.fetch_calls == 1 {
                    vec![
                        ...
                        BrokerEvent::Fill {
                            ...
                            broker_fill_id: Some("02r-cancel-econ-fill-1".to_string()),
                            internal_order_id: order_id,
                            broker_order_id: Some("broker-race".to_string()),
                            symbol: "SPY".to_string(),
                            side: Side::Buy,
                ...
                if s.fetch_calls == 1 {
                    vec![
                        BrokerEvent::Fill {
                            ...
                            broker_fill_id: Some("02r-replace-econ-fill-1".to_string()),
                            internal_order_id: order_id.clone(),
            ...
            HostileScenario::ReplayAfterCursorLoss => {
                if cursor.is_none() {
                    vec![BrokerEvent::Fill {
                        ...
                        broker_fill_id: Some("02r-replay-econ-fill-1".to_string()),
                        internal_order_id: order_id,
