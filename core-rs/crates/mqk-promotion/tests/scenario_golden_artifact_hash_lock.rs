...
fn no_artifact_lock_blocks_promotion() {
    let input = PromotionInput {
        ...
        oos_evidence: Some(VerifiedPromotionOosEvidence::valid_for_testing("no_lock_trial")), // P7C: isolate B6 gate
    };
...
fn valid_lock_admits_promotion() {
    ...
    let input = PromotionInput {
        ...
        oos_evidence: Some(VerifiedPromotionOosEvidence::valid_for_testing("valid_lock_trial")), // P7C
    };
...
fn new_for_testing_is_accepted_by_evaluator() {
    ...
    let input = PromotionInput {
        ...
        stress_suite: Some(StressSuiteResult::pass(1)),
        artifact_lock: Some(lock),
        oos_evidence: Some(VerifiedPromotionOosEvidence::valid_for_testing("new_for_testing_lock_trial")), // P7C
    };
